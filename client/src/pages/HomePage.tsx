      ...
      >
        <div className="flex-1 space-y-6">
          ...
          <p className="max-w-xl text-sm leading-relaxed text-slate-300 md:text-base">
            ...
            clutter, just the signal you care about, wrapped in a peaceful dark
            UI.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-14">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/5 bg-slate-900/70 p-5">
              <h3 className="text-sm font-medium text-slate-50">Minimal UI</h3>
            ...
            <div className="rounded-2xl border border-white/5 bg-slate-900/70 p-5">
              <h3 className="text-sm font-medium text-slate-50">Calm Colors</h3>
              <p className="mt-2 text-xs text-slate-300">
